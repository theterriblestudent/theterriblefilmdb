...
/*
 * Displays the trending movies and tv shows.
 */
function TrendingSection({data, getContent, getTabs,titleText, buttonsRef} ) {
    if (document.documentElement.clientWidth > 768)
        return <ContentStripe buttonsRef={buttonsRef} top="-150px"
            titleText={titleText} getContent={ getContent } getTabs={ getTabs } />;
    else
